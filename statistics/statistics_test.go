...
import (
	...
	"github.com/koestler/go-mqtt-to-influx/v2/statistics/mock"
	"testing"
	"time"
)

//go:generate mockgen -destination=mock/config_mock.go -package statistics_mock github.com/koestler/go-mqtt-to-influx/v2/statistics Config
